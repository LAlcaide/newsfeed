      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-container-style u-expanded-width u-grey-5 u-group u-radius-30 u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1">
            <div class="u-form u-form-1">
              <form action="#" autocomplete="off" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="custom" name="form" style="padding: 10px;">
                <div class="u-form-group u-form-group-1">
                  ...
                  <input type="text" v-model="commentInput" placeholder="" id="text-511b" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                </div>
            ...
            <div v-for="(commentt, comindex) in comments" :key="comindex" class="u-container-style u-expanded-width u-group u-radius-10 u-shape-round u-white u-group-2" style="margin-bottom: 15px;">
              <div class="u-container-layout u-container-layout-2">
                <p class="u-text u-text-1" style="font-size: 15px">{{commentt}}<br>
                </p><span @click="removeComment(index, comindex)" class="u-custom-color-1 u-file-icon u-hover-feature u-icon u-icon-circle u-text-white u-icon-1"><img src="@/assets/1665612.png" alt=""></span><span @click="togglecoms(commentt, comindex)" class="u-file-icon u-hover-feature u-icon u-icon-rectangle u-icon-2"><img src="@/assets/1159633.png" alt=""></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="u-form u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" style="padding: 10px" source="email" name="form">
              <div class="u-form-group u-form-message">
                <textarea v-model="commentEdit" id="email-8999" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"></textarea>
              </div>
              <div class="u-align-left u-form-group u-form-submit">
                <a @click="updateComment(index, editcomindex, commentEdit)" class="u-btn u-btn-submit u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1">Submit</a>
                <input type="submit" value="submit" class="u-form-control-hidden">
              </div>
              <input type="hidden" value="" name="recaptchaResponse">
            </form>
...
export default defineComponent({
    ...
    setup(props, {emit}) {
        var commentInput = ref<string>("");
        var commentEdit = ref<string>("");
        var editcoms = ref<boolean>(false);
        var editcomindex = ref<number>(0);
        ...
        const togglecoms = (commentt: string, comindex: number) => {
          editcoms.value = !editcoms.value
          commentEdit.value = commentt 
          editcomindex.value = comindex
        }
        const updateComment = (index: number, editcomindex: number, commentEdit: string) => {
          emit("edit-comment", index, editcomindex, commentEdit)
          editcoms.value = false
        }
        return{addComment, commentInput, removeComment, editcoms, togglecoms, commentEdit, editcomindex, updateComment}
    },
})
</script>
