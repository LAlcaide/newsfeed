<template>
<section class="u-align-center u-clearfix u-section-2" id="carousel_b3c0" v-for="(postt, index) in posts" :key="index">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1"><!--blog--><!--blog_options_json--><!--{"type":"Recent","source":"","tags":"","count":""}--><!--/blog_options_json-->
          ...
          <div class="u-repeater u-repeater-1"><!--blog_post-->
            <div class="u-blog-post u-border-2 u-border-black u-container-style u-radius-39 u-repeater-item u-shape-round u-repeater-item-1">
              <div class="u-container-layout u-similar-container u-container-layout-1"><!--blog_post_header-->
                ...
                <div class="u-blog-control u-post-content u-text u-text-2"><!--blog_post_content_content-->{{postt.message}}<!--/blog_post_content_content--></div><!--/blog_post_content--><span @click="showComments(index)" class="u-border-2 u-border-black u-file-icon u-hover-feature u-icon u-icon-circle u-text-black u-icon-3"><img src="@/assets/1450338.png" alt=""></span><span @click="heartClicked(index)" class="u-border-2 u-border-black u-file-icon u-hover-feature u-icon u-icon-circle u-text-black u-icon-4"><img src="@/assets/833300.png" alt=""></span><span v-if="postt.liked == 1" @click="heartClicked(index)" class="u-border-2 u-border-black u-file-icon u-icon u-icon-circle u-palette-2-base u-text-black u-icon-5"><img src="@/assets/833300.png" alt=""></span><!--blog_post_readmore-->
                <router-link :to="{name: 'Post', params: {index:index}}" @click="saveData" class="u-blog-control u-btn u-button-style u-hover-palette-1-dark-1 u-palette-1-base u-btn-1"><!--blog_post_readmore_content--><!--options_json--><!--{"content":"","defaultValue":"Read More"}--><!--/options_json-->Read More<!--/blog_post_readmore_content--></router-link><!--/blog_post_readmore--><router-view />
        ...
        <Comments v-if="postt.showcoms == 1" :comments="postt.comments" :index="index" @add-comment="addComments" @remove-comment="removeComments" @edit-comment="editComments"/>
      </div>
    </section>
</template>
<script lang="ts">
...
export default defineComponent({
    emits: ["heart-clicked", "remove-post", "edit-post", "show-comments", "add-comments", "remove-comments", "edit-comments", "show-post", "save-data"],
    components: {Comments},
    props: {
        posts: {
            required: true,
    ...
    setup(props, {emit}) {
        ...
        return{heartClicked, removePost, editPost, showComments, addComments, removeComments, editComments, saveData}
    }
})
</script>
